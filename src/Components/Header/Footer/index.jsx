...
function Footer() {
  ...
  return (
    <div className="h-[100vh] flex flex-col">
      <div className="flex-2 flex flex-col h-[60vh] items-center justify-center p-4 ">
        <div className="mb-8 text-center">
          <h1 className="text-[#56B280] font-semibold text-[48px] tracking-widest mt-[-15%]">
            Popular
          </h1>
          <p className="text-gray-700 text-[16px] tracking-wider ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {popularItems.map((item) => (
            ...
            >
              <div
                className="relative mx-3 mt-3 flex  overflow-hidden rounded-xl h-[200px]"
              ...
              <div className="mt-4 px-5 pb-5">
                ...
                <div className="flex items-center justify-between">
                  <button
                    type="button"
                    className="text-white bg-gradient-to-r from-[#56B280] to-green-500 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 shadow-lg shadow-green-500/50 dark:shadow-lg dark:shadow-green-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
                  >
                    Add to Cart
                  </button>
                  <a
      ...
      <div className="flex-1 bg-gray-300 flex items-center justify-center rounded-tl-2xl rounded-tr-2xl h-[40vh] overflow-hidden">
