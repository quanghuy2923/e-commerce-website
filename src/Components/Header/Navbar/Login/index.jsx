...
function LoginRegister({ onLoginSuccess, onRegisterSuccess }) {
  ...
  const handleLogin = async (e) => {
    e.preventDefault();
    // Cập nhật kiểm tra đăng nhập với trạng thái email và password
  ...
  const handleRegister = (e) => {
    ...
    // Cập nhật kiểm tra đăng ký với trạng thái email và password
            ...
            <form onSubmit={isRegistering ? handleRegister : handleLogin}>
              <div className="mb-4">
                <input
                  ...
                  className="mt-1 block w-full px-3 py-2 border border-gray-700 rounded-md shadow-sm bg-gray-900 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
