import { items } from "../ProductPage";
import { useState } from "react";

function Footer() {
  const [selectedImage, setSelectedImage] = useState(null);

  // Lấy 4 sản phẩm đầu tiên từ danh sách items
    ...
    <div className="min-h-screen flex flex-col">
      <div className="flex-grow flex flex-col items-center justify-center p-4 py-12">
        <div className="mb-8 text-center">
          <h1 className="text-[#56B280] font-semibold text-3xl md:text-4xl lg:text-5xl tracking-widest">
            Popular
          </h1>
          <p className="text-gray-700 text-sm md:text-base tracking-wider mt-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-7xl">
          {popularItems.map((item) => (
            ...
            >
              <div
                className="relative mx-3 mt-3 flex overflow-hidden rounded-xl h-48 sm:h-56"
              ...
              >
                <img
                  ...
                  alt={item.title}
                  className="object-cover transition-transform duration-300 ease-in-out transform hover:scale-105 cursor-pointer w-full h-full"
                />
              ...
              <div className="mt-4 px-5 pb-5">
                ...
                <div className="flex items-center justify-center">
                  <button
                    type="button"
                    className="text-white bg-gradient-to-r from-[#56B280] to-green-500 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 shadow-lg shadow-green-500/50 dark:shadow-lg dark:shadow-green-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center w-full"
                  >
                    Add to Cart
                  </button>
                </div>
      ...
      <div className="bg-gray-300 rounded-t-2xl overflow-hidden">
            ...
            <div className="max-w-3xl mx-auto">
              <a href="https://pagedone.io/" className="flex justify-center">
                <img
                  ...
                  alt="Shop Logo"
                  className="h-12 w-12 md:h-16 md:w-16 mr-2 mt-5"
                />
              </a>
              <ul className="text-base md:text-lg flex flex-wrap items-center justify-center gap-4 md:gap-7 transition-all duration-500 py-8 md:py-16 mb-6 md:mb-10 border-b border-gray-200">
                <li>
              ...
              <div className="flex space-x-6 md:space-x-10 justify-center items-center mb-8 md:mb-14">
                {/* Social media icons */}
              ...
              <span className="text-sm md:text-lg text-gray-500 text-center block">
                ©<a href="#">Sunview</a> 2024, All rights reserved.
              </span>
            </div>
          </div>
        </footer>
